      ...
      <div name = 'work' className='w-full h-screen bg-[#070707] text-gray-300' style={{display:"table"}}>
            <div className='flex flex-col justify-center items-center w-full h-full'>
              ...
              <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-12 ">
                  ...
                  {/* Project 1 */}
                  <div style={{backgroundImage:`url(${anflixImg})`,backgroundSize: 'cover'}} className='grid gap-4 object-contain content-div rounded-lg'>
                      {/* Card */}
                  ...
                  {/* Project 2 */}
                  <div style={{backgroundImage:`url(${covidScreens})`,backgroundSize: 'cover'}} className='grid gap-4 object-contain rounded-lg'>
                      {/* Card */}
                      <div className='shadow-lg shadow-slate-800 group container rounded-md flex justify-center items-center mx-auto content-div'>
                          ...
                          <div className='opacity-0 group-hover:opacity-100 text-center'>
                              ...
                              <div className='pt-8 text-center'>
                                  ...
                                  <button className='text-center rounded-lg px-4 py-2 bg-white text-gray-700 font-bold m-5'
                                    onClick={() => handleClick("Covid Screens", ["Designed and implemented a covid screen tracker using covid19india apis with summary, graphical data.","Created a simple dashboard of Covid data using React library with help of Ant Design."])}
                                   >
                                        More info
                                  </button>
                                  <div class="px-6 pt-4 pb-2 text-center">
                  ...
                  {/* Project 3 */}
                      <div style={{backgroundImage:`url(${wallpse})`,backgroundSize: 'cover'}} className='grid gap-4 object-contain rounded-lg'>
                          {/* Card */}
                          <div className='shadow-lg shadow-slate-800 group container rounded-md flex justify-center items-center mx-auto content-div'>
                              {/* Hover effect */}
                              <div className='opacity-0 group-hover:opacity-100 text-center'>
                                  <span className='text-2xl font-bold text-white tracking-wider m-12'>
                                       Wallpse Android App
                                  </span>
                                  <div className='pt-8 text-center'>
                                      ...
                                      <button className='text-center rounded-lg px-4 py-2 bg-white text-gray-700 font-bold m-5'
                                            onClick={() => handleClick("Wallpse Android App", ["An app uses a public API for dog images to display on user screen on scrolling (infinite scroll) and used JavaScript library for basic device details."] )}
                                        >
                                                More info
                                        </button>
                                      <div class="px-6 pt-4 pb-2 text-center">
                      ...
                      {/* Project 4 */}
                      <div style={{backgroundImage:`url(${sih2017})` ,backgroundSize: 'cover'}} className='grid gap-4 object-contain rounded-lg'>
                          {/* Card */}
                          <div className='shadow-lg shadow-slate-800 group container rounded-md flex justify-center items-center mx-auto content-div'>
                              {/* Hover effect */}
                              <div className='opacity-0 group-hover:opacity-100 text-center'>
                                  ...
                                  <div class="font-small text-xs font-bold text-white">(Smart India Hackathon 2017, Government of India)</div>

                                  <div className='pt-8 text-center'>
                                      <button className='text-center rounded-lg px-4 py-2 bg-white text-gray-700 font-bold m-5'
                                            onClick={() => handleClick("UGC Dashboard - Government of India 2017", ["A web application as part of the first Government organized hackathon that enables UGC employees to maintain data in digital format instead of physical files.","I worked on creating interactive UI dashboards with all required details and tools such as notifications, video & chat support which enabled UGC to make faster decisions related to accreditation and distribution of grants."] )}
                                        >
                                                More info
                                        </button>
                                      <div class="px-6 pt-4 pb-2 text-center">
